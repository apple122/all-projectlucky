      ...
      <tr key={index}>
        ...
        <td className="col-2">
          <div className="btn-group btn-group-sm">
            ...
            <button onClick={() => deleteDistrict(item.id)} class="btn btn-danger"><i class="fas fa-trash"></i></button>
          </div>
        </td>
      </tr>
    )
          ...
          <div className="container-fluid">
            <div className="row">
              ...
              <div className="col-12">
                <div className="card">
                  <div className="card-header">
                    <h3 className="card-title">ຂໍ້ມູນເມືອງ</h3>
                  ...
                  <div className="card-body table-responsive p-0">
                    <table className="table table-hover text-nowrap">
                      ...
                      <tbody>
                        ...
                        {District.length === 0 ? <h1 className='text-center'>ບໍ່ມີຂໍ້ມູນ</h1> : ""}
