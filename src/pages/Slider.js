        ...
        <div className="container-fluid">
          <div className="row">
            ...
            <div className="col-12">
              <div className="card">
                <div className="card-header">
                  <h3 className="card-title">ຂໍ້ມູນ Slide</h3>
                  ...
                  <table className="table table-hover text-nowrap">
                    ...
                    <tbody>
                      {slider.filter((e) => e.name.toLowerCase().includes(filteredText)).map((item,index) => (
                         ...
                         <td valign='middle'><img style={{maxWidth: 150+'px', height: 100+'px'}} src={url.photo + item.image}></img></td>
                         <td class="text-center py-0 align-middle">
                           <div class="btn-group btn-group-sm">
                             <EditSliderModal name={item.name} id={item.id} image={item.image} showModal={showModal} setshowModal={setshowModal}></EditSliderModal>&nbsp;
